...
model = YOLO("path/to/yolov8m.pt")  # Load a custom trained model
...
yolo track model=path/to/yolov8m.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/yolov8m.pt tracker="bytetrack.yaml"
```
